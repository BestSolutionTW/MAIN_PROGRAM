...
message '****************************************************************'
message '*PROJECT NAME :MAIN PROGRAM V104                               *'
message '*     VERSION :V104                                            *'
message '* ICE VERSION :                                                *'
message '*      DATE   :20171123                                        *'
message '*      REMARK :V104 add 37~40 key                              *'
message '****************************************************************'
                ;=INCLUDE REFERENCE FILE
                INCLUDE MAIN_PROGRAM_V104.INC
...
_LOAD_HXT_REFERENCE:
                ...
                if      TouchKeyAmount > 36
                ;-KEY37 THRESHOLD
                MOV     A,Key37Threshold
                MOV     _GLOBE_VARIES[39],A
                endif

                if      TouchKeyAmount > 37
                ;-KEY38 THRESHOLD
                MOV     A,Key38Threshold
                MOV     _GLOBE_VARIES[40],A
                endif

                if      TouchKeyAmount > 38
                ;-KEY39 THRESHOLD
                MOV     A,Key39Threshold
                MOV     _GLOBE_VARIES[41],A
                endif

                if      TouchKeyAmount > 39
                ;-KEY40 THRESHOLD
                MOV     A,Key40Threshold
                MOV     _GLOBE_VARIES[42],A
                endif
