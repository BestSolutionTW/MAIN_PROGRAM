                INCLUDE WHEEL_SLIDE_V100.INC


                PUBLIC  _WHEEL_SLIDE_V100_INITIAL
                PUBLIC  _WHEEL_SLIDE_V100
                PUBLIC  _WHEEL_SLIDE_POS

        ifndef _WHEEL_SLIDE_V100_
                #define WS_PAD1      0
                #define WS_PAD2      1
                #define WS_PAD3      2
                #define WS_PAD4      3
                ...
                #define BackgroundValue 5       ; 0~128 Back ground Value
